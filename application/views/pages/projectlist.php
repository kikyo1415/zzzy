            ...
            <div class="col-md-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <!--start table filter setting-->
                        <div style="display: flex">
                            <p style="padding: 5px;">
                                <input class="icheckbox_flat-green checked"/> 不看已释放的
                                <input class="icheckbox_flat-green checked"/>不看已流标的
                                <input class="icheckbox_flat-green "/>不看已签单的
                                <input class="icheckbox_flat-green "/>只看自己当前账号的
                            </p>
                        </div>
                        <!--end table filter setting-->
                        <!-- start project list -->
